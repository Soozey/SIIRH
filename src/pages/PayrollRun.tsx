    ...
    <div className="min-h-screen bg-gray-50 p-4 md:p-6">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 mb-6">
          ...
          {/* Nouvelle disposition avec flex pour mieux contrôler l'alignement */}
          <div className="flex flex-col md:flex-row gap-4 items-start md:items-end">
            ...
            {/* Bouton Charger - Hauteur fixe pour l'alignement */}
            <div className="w-full md:w-auto">
              <div className="h-6 mb-2 invisible">
                {/* Espaceur invisible pour aligner avec les labels */}
                Label
              </div>
              <button
                onClick={load}
                disabled={isLoading}
                className="w-full md:w-auto min-w-[140px] inline-flex items-center justify-center gap-2 bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed px-6 py-3 rounded-xl font-medium transition-all duration-200 hover:shadow-lg whitespace-nowrap"
              >
                {isLoading ? (
                  <>
          ...
          {preview && (
            <div className="flex justify-end mt-6 pt-6 border-t border-gray-200">
              <Link
                ...
                className="inline-flex items-center gap-2 bg-green-600 text-white hover:bg-green-700 px-6 py-3 rounded-xl font-medium transition-all duration-200 hover:shadow-lg"
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                  ...
                  {preview.salaire_brut && (
                    <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 text-center">
                      ...
                      <div className="text-sm text-blue-600 font-medium">Salaire Brut</div>
                    </div>
                  )}
                  ...
                  {preview.total_heures_supp && (
                    <div className="bg-orange-50 border border-orange-200 rounded-xl p-4 text-center">
                      ...
                      <div className="text-sm text-orange-600 font-medium">Heures Supp.</div>
                    </div>
                  )}
                  ...
                  {preview.total_primes && (
                    <div className="bg-purple-50 border border-purple-200 rounded-xl p-4 text-center">
                      ...
                      <div className="text-sm text-purple-600 font-medium">Total Primes</div>
                    </div>
                  )}
                </div>
              )}
...
{JSON.stringify(preview, (key, value) => {
  if (typeof value === 'number' && (key.toLowerCase().includes('salaire') || key.toLowerCase().includes('montant'))) {
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-blue-700 text-sm">
                      Cette prévisualisation montre les données calculées pour le bulletin de paie.
                      Cliquez sur "Voir le Bulletin Complet" pour accéder à la version formatée et imprimable.
                    </p>
                  </div>
                </div>
              </div>
        ...
        {!preview && !isLoading && (
          <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-12 text-center">
            ...
            <p className="text-gray-600 mb-6 max-w-md mx-auto">
              Sélectionnez un travailleur et une période, puis cliquez sur "Prévisualiser" pour afficher les données du bulletin.
            </p>
