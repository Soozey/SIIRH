...
export default function EmploymentAttestation({ worker, employer, onClose }: Props) {
    ...
    const handlePrint = usePrint(`Attestation_Emploi_${displayWorker.nom}_${displayWorker.prenom}`);
    ...
    return (
        <div className="flex flex-col h-full bg-gray-100 p-4 overflow-auto print:bg-white print:p-0">
            ...
            <div className="max-w-[210mm] mx-auto mb-2 text-xs text-blue-600 bg-blue-50 px-3 py-1 rounded-full border border-blue-100 flex items-center gap-2 animate-pulse print:hidden w-fit">
                ...
                <span>Les champs sont cliquables et editables directement sur le document avant impression</span>
            </div>
            ...
            >
                ...
                <div className="mb-8 space-y-6 text-justify leading-normal">
                    ...
                    <p contentEditable suppressContentEditableWarning>
                        Est employe(e) au sein de notre societe depuis le <strong>{formatDate(displayWorker.date_embauche)}</strong>.
                    </p>

                    <p contentEditable suppressContentEditableWarning>
                        Il/Elle occupe actuellement le poste de <strong>{displayWorker.poste || displayWorker.categorie_prof || "...................."}</strong> sous contrat de type <strong>{displayWorker.nature_contrat || "CDI"}</strong>.
                    </p>

                    <p contentEditable suppressContentEditableWarning>
                        Cette attestation est delivree a la demande de l'interesse(e) pour servir et valoir ce que de droit.
                    </p>
                </div>
